<template>
  <div class="comment">
    <div class="comment-container-left">
      ...
      <div class="hukidasi-left"></div>
    </div>
    <!-- ex -->
    <!-- <div class="comment-container-left">
      <span class="comment-text">
        englishはこんな感じ。123はこんな感じ。あああああああああああああああああああああああ
      </span>
      <div class="comment-userinfo">
        <div class="comment-job">
          <span class="comment-job-text">ビジネス職</span>
        </div>
        <div class="comment-born">
          <span class="comment-born-text">鹿児島県</span>
        </div>
      </div>
      <div class="hukidasi-left"></div>
    </div>
...
.hukidasi-left{
  position: absolute;
  margin: 0;
  border-top: 40px solid rgb(177, 174, 174);
